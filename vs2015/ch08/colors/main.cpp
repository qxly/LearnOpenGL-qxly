...
int main()
{
	...
	glm::vec3 lightColor(0.33, 0.42, 0.18);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(object._program, "u_objectColor"), 0.0, 0.5, 0.0);
		...
		glUniformMatrix4fv(glGetUniformLocation(object._program, "u_mat"), 1, GL_FALSE, glm::value_ptr(matLight));
		glUniform3fv(glGetUniformLocation(object._program, "u_lightColor"), 1, glm::value_ptr(lightColor));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		glBindVertexArray(0);
