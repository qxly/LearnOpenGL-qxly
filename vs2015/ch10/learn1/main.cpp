...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::vec3 ambientColor = lightColor * glm::vec3(1.0);
		glm::vec3 diffuseColor = lightColor * glm::vec3(1.0);		
		...
		glUniform3f(glGetUniformLocation(object._program, "u_material.ambient"), 0.0, 0.1, 0.06);
		glUniform3f(glGetUniformLocation(object._program, "u_material.diffuse"), 0.0, 0.50980392, 0.50980392);
		glUniform3f(glGetUniformLocation(object._program, "u_material.specular"), 0.50980392, 0.50980392, 0.50980392);
