...
int main()
{
	...
	std::string normal_vs = workDir + "/normal.vs";
	std::string normal_frag = workDir + "/normal.frag";
	std::string normal_gs = workDir + "/normal.gs";
	Shader shader_normal(normal_vs.c_str(), normal_frag.c_str(), normal_gs.c_str());
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// draw normal
		shader_normal.use();
		glUniformMatrix4fv(glGetUniformLocation(shader_normal.program, "projection"), 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(glGetUniformLocation(shader_normal.program, "view"), 1, GL_FALSE, glm::value_ptr(view));
		glUniformMatrix4fv(glGetUniformLocation(shader_normal.program, "model"), 1, GL_FALSE, glm::value_ptr(model));
		modelObj.draw(shader_normal);
