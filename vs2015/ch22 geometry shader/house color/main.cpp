...
int main()
{
	...
	// shader
	std::string shader_vs = workDir + "/advanced.vs";
	std::string shader_frag = workDir + "/advanced.frag";
	std::string shader_gs = workDir + "/advanced.gs";
...
#pragma region "object_initialization"
	...
	GLfloat cubeVertices[] = {
		-0.5f,  0.5f, 1.0f, 0.0f, 0.0f, // 左上方
		0.5f,  0.5f,  0.0f, 1.0f, 0.0f,// 右上方
		0.5f, -0.5f,  0.0f, 0.0f, 1.0f,// 右下方
		-0.5f, -0.5f,  1.0f, 1.0f, 0.0f// 左下方
	};
