...
int main()
{
	...
	// game loop
	std::string objectvs = "D:/OpenGL/LearnOpenGL/vs2015/ch09/basic lighting/object.vs";
	std::string objectfrag = "D:/OpenGL/LearnOpenGL/vs2015/ch09/basic lighting/object.frag";
	//Shader object("../object.vs", "../object.frag");
	std::string lightvs = "D:/OpenGL/LearnOpenGL/vs2015/ch09/basic lighting/light.vs";
	std::string lightfrag = "D:/OpenGL/LearnOpenGL/vs2015/ch09/basic lighting/light.frag";
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(object._program, "u_objectColor"), 1.0, 0.5, 0.31);
		
		glUniform3fv(glGetUniformLocation(object._program, "u_lightColor"), 1, glm::value_ptr(lightColor));
		glUniformMatrix4fv(glGetUniformLocation(object._program, "u_matModel"), 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(glGetUniformLocation(object._program, "u_lightPos"), 1, glm::value_ptr(lightPos));
