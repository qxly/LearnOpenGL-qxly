...
int main()
{
	...
	// game loop
	std::string objectvs = "D:/LearnOpenGL/vs2015/ch09/basic lighting2/object.vs";
	std::string objectfrag = "D:/LearnOpenGL/vs2015/ch09/basic lighting2/object.frag";
	//Shader object("../object.vs", "../object.frag");
	std::string lightvs = "D:/LearnOpenGL/vs2015/ch09/basic lighting2/light.vs";
	std::string lightfrag = "D:/LearnOpenGL/vs2015/ch09/basic lighting2/light.frag";
