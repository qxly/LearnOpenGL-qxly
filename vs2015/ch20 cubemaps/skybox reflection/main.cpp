...
#pragma endregion
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3fv(glGetUniformLocation(advanced_shader.program, "u_cameraPos"), 1, glm::value_ptr(camera.Position));
		glActiveTexture(skyboxTexture);
		glUniform1i(glGetUniformLocation(advanced_shader.program, "texture1"), 0);
		...
		skybox_shader.use();
		//glUniformMatrix4fv(glGetUniformLocation(skybox_shader.program, "model"), 1, GL_FALSE, glm::value_ptr(model));
