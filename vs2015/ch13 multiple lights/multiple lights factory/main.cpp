...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(object._program, "dirLight.ambient"), 0.05f, 0.05f, 0.1f);

		glUniform3f(glGetUniformLocation(object._program, "dirLight.diffuse"), 0.2f, 0.2f, 0.7);

		glUniform3f(glGetUniformLocation(object._program, "dirLight.specular"), 0.7f, 0.7f, 0.7f);
		// Point light 1
		...
		glUniform1f(glGetUniformLocation(object._program, "spotLight.linear"), 0.009);

		glUniform1f(glGetUniformLocation(object._program, "spotLight.quadratic"), 0.0032);

		glUniform1f(glGetUniformLocation(object._program, "spotLight.cutOff"), glm::cos(glm::radians(10.0f)));

		glUniform1f(glGetUniformLocation(object._program, "spotLight.outerCutOff"), glm::cos(glm::radians(12.5f)));
