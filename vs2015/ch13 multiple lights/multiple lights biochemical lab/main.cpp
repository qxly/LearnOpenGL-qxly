...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(object._program, "dirLight.ambient"), 0.5f, 0.5f, 0.5f);

		glUniform3f(glGetUniformLocation(object._program, "dirLight.diffuse"), 1.0f, 1.0f, 1.0f);

		glUniform3f(glGetUniformLocation(object._program, "dirLight.specular"), 1.0f, 1.0f, 1.0f);
		// Point light 1
		...
		glUniform1f(glGetUniformLocation(object._program, "pointLights[0].linear"), 0.07);

		glUniform1f(glGetUniformLocation(object._program, "pointLights[0].quadratic"), 0.017);
		// Point light 2
		...
		glUniform1f(glGetUniformLocation(object._program, "pointLights[1].linear"), 0.07);

		glUniform1f(glGetUniformLocation(object._program, "pointLights[1].quadratic"), 0.017);
		// Point light 3
		...
		glUniform1f(glGetUniformLocation(object._program, "pointLights[2].linear"), 0.07);

		glUniform1f(glGetUniformLocation(object._program, "pointLights[2].quadratic"), 0.017);
		// Point light 4
		...
		glUniform1f(glGetUniformLocation(object._program, "pointLights[3].linear"), 0.07);

		glUniform1f(glGetUniformLocation(object._program, "pointLights[3].quadratic"), 0.017);
		// SpotLight
		...
		glUniform3f(glGetUniformLocation(object._program, "spotLight.diffuse"), 0.0f, 1.0f, 0.0f);

		glUniform3f(glGetUniformLocation(object._program, "spotLight.specular"), 0.0f, 1.0f, 0.0f);

		glUniform1f(glGetUniformLocation(object._program, "spotLight.constant"), 1.0f);
		
		glUniform1f(glGetUniformLocation(object._program, "spotLight.linear"), 0.07);

		glUniform1f(glGetUniformLocation(object._program, "spotLight.quadratic"), 0.017);

		glUniform1f(glGetUniformLocation(object._program, "spotLight.cutOff"), glm::cos(glm::radians(7.0f)));

		glUniform1f(glGetUniformLocation(object._program, "spotLight.outerCutOff"), glm::cos(glm::radians(10.0f)));
