...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(object._program, "dirLight.ambient"), 0.05f, 0.05f, 0.05f);
		glUniform3f(glGetUniformLocation(object._program, "dirLight.diffuse"), 0.4f, 0.4f, 0.4f);
		glUniform3f(glGetUniformLocation(object._program, "dirLight.specular"), 0.5f, 0.5f, 0.5f);
		// Point light 1
		...
		glUniform3f(glGetUniformLocation(object._program, "pointLights[0].ambient"), 0.05f, 0.05f, 0.05f);
		glUniform3f(glGetUniformLocation(object._program, "pointLights[0].diffuse"), 0.8f, 0.8f, 0.8f);
		glUniform3f(glGetUniformLocation(object._program, "pointLights[0].specular"), 1.0f, 1.0f, 1.0f);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[0].constant"), 1.0f);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[0].linear"), 0.09);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[0].quadratic"), 0.032);
		// Point light 2
		...
		glUniform3f(glGetUniformLocation(object._program, "pointLights[1].ambient"), 0.05f, 0.05f, 0.05f);
		glUniform3f(glGetUniformLocation(object._program, "pointLights[1].diffuse"), 0.8f, 0.8f, 0.8f);
		glUniform3f(glGetUniformLocation(object._program, "pointLights[1].specular"), 1.0f, 1.0f, 1.0f);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[1].constant"), 1.0f);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[1].linear"), 0.09);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[1].quadratic"), 0.032);
		// Point light 3
		...
		glUniform3f(glGetUniformLocation(object._program, "pointLights[2].ambient"), 0.05f, 0.05f, 0.05f);
		glUniform3f(glGetUniformLocation(object._program, "pointLights[2].diffuse"), 0.8f, 0.8f, 0.8f);
		glUniform3f(glGetUniformLocation(object._program, "pointLights[2].specular"), 1.0f, 1.0f, 1.0f);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[2].constant"), 1.0f);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[2].linear"), 0.09);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[2].quadratic"), 0.032);
		// Point light 4
		...
		glUniform3f(glGetUniformLocation(object._program, "pointLights[3].ambient"), 0.05f, 0.05f, 0.05f);
		glUniform3f(glGetUniformLocation(object._program, "pointLights[3].diffuse"), 0.8f, 0.8f, 0.8f);
		glUniform3f(glGetUniformLocation(object._program, "pointLights[3].specular"), 1.0f, 1.0f, 1.0f);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[3].constant"), 1.0f);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[3].linear"), 0.09);
		glUniform1f(glGetUniformLocation(object._program, "pointLights[3].quadratic"), 0.032);
		// SpotLight
		...
		glUniform1f(glGetUniformLocation(object._program, "spotLight.cutOff"), glm::cos(glm::radians(12.5f)));
