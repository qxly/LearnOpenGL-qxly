...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(object._program, "dirLight.ambient"), 0.3f, 0.24f, 0.14f);

		glUniform3f(glGetUniformLocation(object._program, "dirLight.diffuse"), 0.7f, 0.42f, 0.26f);
		...
		glUniform3f(glGetUniformLocation(object._program, "spotLight.diffuse"), 0.8f, 0.8f, 0.0f);

		glUniform3f(glGetUniformLocation(object._program, "spotLight.specular"), 0.8f, 0.8f, 0.0f);
		...
		glUniform1f(glGetUniformLocation(object._program, "spotLight.outerCutOff"), glm::cos(glm::radians(13.0f)));
