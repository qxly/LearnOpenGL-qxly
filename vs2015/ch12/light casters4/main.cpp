...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3fv(glGetUniformLocation(object._program, "u_light.position"), 1, glm::value_ptr(camera.Position));
		glUniform3fv(glGetUniformLocation(object._program, "u_light.direction"), 1, glm::value_ptr(camera.Front));
		glUniform1f(glGetUniformLocation(object._program, "u_light.cutoff"), glm::cos(glm::radians(12.5)));
		glUniform1f(glGetUniformLocation(object._program, "u_light.outercutoff"), glm::cos(glm::radians(17.5)));
		glUniform1f(glGetUniformLocation(object._program, "u_light.constant"), 1.0);
		glUniform1f(glGetUniformLocation(object._program, "u_light.linear"), 0.022);
		glUniform1f(glGetUniformLocation(object._program, "u_light.quadratic"), 0.0019);
