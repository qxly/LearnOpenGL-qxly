...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//glUniform3f(glGetUniformLocation(object._program, "u_light.direction"), -0.2, -1.0, -0.3);
		...
		glm::mat4 proj_light;
		proj_light = glm::perspective(glm::radians(camera.Zoom), (float)width / (float)height, 0.1f, 100.0f);
		glm::mat4 matLight = proj_light * view * model_light;
