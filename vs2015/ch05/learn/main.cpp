...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		mat = glm::rotate(mat, (GLfloat)glfwGetTime() * 50.0f, glm::vec3(0.0, 0.0, 1.0));

		glm::mat4 mat2;
		mat2 = glm::translate(mat2, glm::vec3(-0.5f, 0.5f, 0.0f));
		float scale = sin(glfwGetTime());
		mat2 = glm::scale(mat2, glm::vec3(scale, scale, scale));
		...
		glUniformMatrix4fv(glGetUniformLocation(program._program, "u_mat"), 1, GL_FALSE, glm::value_ptr(mat2));
		glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
