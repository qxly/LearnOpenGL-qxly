...
int main()
{
	...
	Shader shader_advanced(vs_advanced.c_str(), frag_advanced.c_str());
...
#pragma endregion
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// draw cube
		shader_advanced.use();
		glUniformMatrix4fv(glGetUniformLocation(shader_advanced.program, "model"), 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(glGetUniformLocation(shader_advanced.program, "view"), 1, GL_FALSE, glm::value_ptr(view));
		glUniformMatrix4fv(glGetUniformLocation(shader_advanced.program, "projection"), 1, GL_FALSE, glm::value_ptr(projection));
		glBindVertexArray(cubeVAO);
