...
int main()
{
	...
	std::string screen_vs = workDir + "/screen.vs";
	std::string screen_frag = workDir + "/screen.frag";
	Shader screenShader(screen_vs.c_str(), screen_frag.c_str());
...
#pragma region "fbo"
	...
	GLuint textureDepthBuffer = generateAttachmentTexture(true, false);
