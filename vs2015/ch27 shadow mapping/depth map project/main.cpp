...
void renderDepthMap(const Shader& shader) {
	...
	// shadow don't real
	glm::mat4 projection = glm::perspective(camera.Zoom, (float)DEPTHMAP_WIDTH / (float)DEPTHMAP_HEIGHT, 1.0f, 7.5f);
	glm::mat4 view = glm::lookAt(lightPos, glm::vec3(0.0), glm::vec3(0.0, 1.0, 0.0));	
...
#pragma region "resource"
	Shader depthmapShader("depthmap.vs", "depthmap.frag");
